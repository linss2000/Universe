...
.ui-growl-enter.ui-growl-enter-active {
  opacity: 1;
...
.ui-growl-leave.ui-growl-leave-active {
	max-height: 0;
	overflow: hidden;
	margin-bottom: 0;
...
.ui-messages-enter.ui-messages-enter-active {
  opacity: 1;
  transition: opacity 250ms ease-in;
}
...
.ui-messages-leave.ui-messages-leave-active {
	max-height: 0;
	overflow: hidden;
	margin-bottom: 0;
