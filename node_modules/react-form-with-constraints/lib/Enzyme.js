...
function findFieldFeedbackList(wrapper, inputName, fieldFeedbackType) {
...
function getFieldFeedbacksMessages(inputs, fieldFeedbackType) {
    if (fieldFeedbackType === void 0) { fieldFeedbackType = index_1.FieldFeedbacks; }
    var messages = [];
    inputs.forEach(function (input) {
        var _a = input.props(), name = _a.name, value = _a.value;
        var fieldFeedbackList = findFieldFeedbackList(input.parents(), name, fieldFeedbackType);
