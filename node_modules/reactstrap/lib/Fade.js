...
function Fade(props) {
  var Tag = props.tag,
      ...
      transitionProps = _objectWithoutProperties(props, ['tag', 'baseClass', 'baseClassActive', 'className', 'cssModule', 'children']);
  ...
  return _react2.default.createElement(
    ...
    transitionProps,
    function (status) {
      var isActive = status === _Transition.ENTERING || status === _Transition.ENTERED;
      var classes = (0, _utils.mapToCssModules)((0, _classnames2.default)(className, baseClass, isActive ? baseClassActive : false), cssModule);
      return _react2.default.createElement(
        Tag,
