export const types = {
    FETCH_TABLES_REQUEST: "PURCHASE/FETCH_REQUEST",
    ITEMS: "PURCHASE/ITEMS",
    DELETE_REQUEST: "PURCHASE/DELETE_REQUEST",
    INSERT_REQUEST: "PURCHASE/INSERT_REQUEST",
    UPDATE_REQUEST: "PURCHASE/UPDATE_REQUEST",
  ...
  export const actions = {
    getPurchases: (payload) => ({ type: payload.type, cname: payload.cname }),
