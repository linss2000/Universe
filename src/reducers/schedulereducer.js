export const types = {
    FETCH_TABLES_REQUEST: "SCHEDULE/FETCH_REQUEST",
    ITEMS: "SCHEDULE/ITEMS",
    DELETE_REQUEST: "SCHEDULE/DELETE_REQUEST",
    INSERT_REQUEST: "SCHEDULE/INSERT_REQUEST",
    UPDATE_REQUEST: "SCHEDULE/UPDATE_REQUEST",
  ...
  export const actions = {
    getSchedules: (payload) => ({ type: payload.type, cname: payload.cname }),
